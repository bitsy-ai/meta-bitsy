...
SRCREV = "389b4ffa1312301d6c558b16483908d406e8b3c4"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV:append = ".AUTOINC+389b4ffa13"
...
SRC_URI += " \
    ...
    git://git@github.com/gtk-rs/gtk-rs-core.git;protocol=ssh;nobranch=1;name=gio-sys;destsuffix=gio-sys;branch=master \
    git://git@github.com/gtk-rs/gtk-rs-core.git;protocol=ssh;nobranch=1;name=glib-macros;destsuffix=glib-macros;branch=master \
    git://git@github.com/gtk-rs/gtk-rs-core.git;protocol=ssh;nobranch=1;name=glib-sys;destsuffix=glib-sys;branch=master \
    git://git@github.com/gtk-rs/gtk-rs-core.git;protocol=ssh;nobranch=1;name=glib;destsuffix=glib;branch=master \
    git://git@github.com/gtk-rs/gtk-rs-core.git;protocol=ssh;nobranch=1;name=gobject-sys;destsuffix=gobject-sys;branch=master \
    git://gitlab.freedesktop.org/gstreamer/gst-plugins-rs;protocol=https;nobranch=1;name=gst-plugin-version-helper;destsuffix=gst-plugin-version-helper;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-app-sys;destsuffix=gstreamer-app-sys;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-app;destsuffix=gstreamer-app;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-base-sys;destsuffix=gstreamer-base-sys;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-base;destsuffix=gstreamer-base;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-check-sys;destsuffix=gstreamer-check-sys;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-check;destsuffix=gstreamer-check;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-sys;destsuffix=gstreamer-sys;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-video-sys;destsuffix=gstreamer-video-sys;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer-video;destsuffix=gstreamer-video;branch=main \
    git://gitlab.freedesktop.org/gstreamer/gstreamer-rs;protocol=https;nobranch=1;name=gstreamer;destsuffix=gstreamer;branch=main \
"
