...
# SRC_URI += "crate://crates.io/printnanny-cli/0.28.0"
SRC_URI += "git://git@github.com/bitsy-ai/printnanny-cli.git;protocol=ssh;nobranch=1;branch=main"
SRCREV = "83c501a61c0cfcc31f63a5172d313a03096abad7"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "cli"
PV:append = ".AUTOINC+83c501a61c"
...
SRC_URI += " \
    ...
    crate://crates.io/printnanny-gst-config/0.1.5 \
