...
# how to get printnanny-nats could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/printnanny-nats/0.26.0"
SRC_URI += "git://git@github.com/bitsy-ai/printnanny-cli.git;protocol=ssh;nobranch=1;branch=main"
SRCREV = "18367332edb40268047a8c4c4d7a9bc9d969528a"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "nats"
...
SUMMARY = "Library of MQTT, API, and other services used by PrintNanny"
...
include printnanny-nats-${PV}.inc
include printnanny-nats.inc
