...
# creation code.
USERADD_PACKAGES = "${PN} ${PN}-printnanny"

# You must also set USERADD_PARAM and/or GROUPADD_PARAM when
# you inherit useradd.
GROUPADD_PARAM:${PN} = "i2c; netdev; video; spi"
USERADD_PARAM:${PN}-printnanny = "-r -U -s /bin/bash -m -d /home/printnanny -G adm,dialout,i2c,input,netdev,plugdev,spi,sudo,video printnanny"
