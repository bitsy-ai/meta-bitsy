...
do_install:append(){
    echo "${PRINTNANNY_USER} ALL=(ALL) NOPASSWD:MOONRAKER_SERVICES,KLIPPER_SERVICES,OCTOPRINT_SERVICES,PRINTNANNY_SERVICES,WEB_SERVICES,REBOOT" > "${WORKDIR}/020_${PRINTNANNY_USER}_rules"
    echo "%${PRINTNANNY_USER} ALL=(ALL) NOPASSWD:MOONRAKER_SERVICES,KLIPPER_SERVICES,OCTOPRINT_SERVICES,PRINTNANNY_SERVICES,WEB_SERVICES,REBOOT" >> "${WORKDIR}/020_${PRINTNANNY_USER}_rules"
