...
DEPENDS = "python3-pyyaml-native python3-jinja2-native python3-ply-native python3-jinja2 udev gnutls boost chrpath-native libevent libyaml gnutls openssl libuv"
...
PACKAGECONFIG[tracing] = "-Dtracing=enabled,-Dtracing=disabled,lttng-ust"
