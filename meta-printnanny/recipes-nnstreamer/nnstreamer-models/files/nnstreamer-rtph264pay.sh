...
gst-launch-1.0 -v libcamerasrc \
    ! capsfilter caps=video/x-raw,width=640,height=480,format=RGB,framerate=10/1 \
    ! tee name=t \
    t.  ! queue leaky=2 max-size-buffers=2 \
        ...
        ! tensor_decoder mode=bounding_boxes option1=mobilenet-ssd-postprocess option2=/usr/share/printnanny/model/dict.txt option3=0:1:2:3,0.66 option4=640:480 option4=640:480 \
