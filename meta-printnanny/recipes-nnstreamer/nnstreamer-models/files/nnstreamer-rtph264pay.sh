...
gst-launch-1.0 --verbose libcamerasrc \
    ...
    t.  ! queue leaky=2 max-size-buffers=2 \
        ...
        ! tensor_decoder mode=bounding_boxes option1=mobilenet-ssd-postprocess option2=/usr/share/printnanny/model/dict.txt option3=0:1:2:3 option4=640:480 option5=320:320 \
        ! capssetter caps="video/x-raw,format=RGBA,width=640,height=480" \
        ! v4l2convert \
